...
namespace System.DJ.ImplementFactory.Pipelines
{
    ...
    public interface IHttpHelper
    {
        ...
        /// <param name="isJson">是否是 json 数据, 如果不是以字节数组方式发送</param>
        /// <param name="methodTypes"></param>
        /// <param name="timeoutOfSecond"></param>
        /// <param name="action">参数1: 返回数据, 参数2: 返回错误信息</param>
        void SendData(string uri, Dictionary<string, string> heads, object data, bool isJson, MethodTypes methodTypes, int timeoutOfSecond, Action<object, string> action);
    }
}
